...
<script src="{{ asset('frontend/theme_base/mining_invest/js/particles.min.js') }}"></script>
<script src="{{ asset('frontend/theme_base/mining_invest/js/particle-app.js') }}"></script>
<script src="{{ asset('frontend/theme_base/mining_invest/js/main.js?var=5') }}"></script>
